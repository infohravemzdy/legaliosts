...
import { HistoryConstTaxing2020 } from './HistoryConstTaxing2020';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2020 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2020.VERSION_CODE));
  }
