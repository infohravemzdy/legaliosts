...
import { HistoryConstTaxing2013 } from './HistoryConstTaxing2013';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2013 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2013.VERSION_CODE));
  }
