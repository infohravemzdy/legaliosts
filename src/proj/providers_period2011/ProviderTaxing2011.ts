...
import { HistoryConstTaxing2011 } from './HistoryConstTaxing2011';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2011 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2011.VERSION_CODE));
  }
