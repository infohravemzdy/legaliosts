...
export interface IPropsSalary extends IProps {
  ...
  paymentRoundUpWithMonthlyAndFullWeekAndFullAndWorkHours(amountMonthly: bigDecimal,
                                                          fullWeekHours: number, partWeekHours: number,
                                                          fullWorkHours: number, partWorkHours: number): bigDecimal;
  paymentWithMonthlyAndCoeffAndFullAndWorkHours(amountMonthly: bigDecimal,
                                                monthlyCoeff: bigDecimal, fullWorkHours: number, partWorkHours: number): bigDecimal;
  paymentRoundUpWithMonthlyAndCoeffAndFullAndWorkHours(amountMonthly: bigDecimal,
                                                       monthlyCoeff: bigDecimal, fullWorkHours: number, partWorkHours: number): bigDecimal;
  paymentWithMonthlyAndCoeffAndWorkCoeff(amountMonthly: bigDecimal,
                                         monthlyCoeff: bigDecimal, workingCoeff: bigDecimal): bigDecimal;
  paymentRoundUpWithMonthlyAndCoeffAndWorkCoeff(amountMonthly: bigDecimal,
                                                monthlyCoeff: bigDecimal, workingCoeff: bigDecimal): bigDecimal;
