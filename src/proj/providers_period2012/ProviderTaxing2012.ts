...
import { HistoryConstTaxing2012 } from './HistoryConstTaxing2012';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2012 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2012.VERSION_CODE));
  }
  ...
  FactorSolitary(period: IPeriod): bigDecimal {
    return HistoryConstTaxing2012.FACTOR_SOLITARY;
  }
  ...
  MarginIncomeOfSolitary(period: IPeriod): number {
    return HistoryConstTaxing2012.MARGIN_INCOME_OF_SOLITARY;
  }
