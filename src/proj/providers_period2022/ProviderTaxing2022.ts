...
import { HistoryConstTaxing2022 } from './HistoryConstTaxing2022';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2022 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2022.VERSION_CODE));
  }
