...
import { HistoryConstSocial2014 } from './HistoryConstSocial2014';
import bigDecimal = require('js-big-decimal');

export class ProviderSocial2014 extends ProviderBase implements IProviderSocial {
  constructor() {
    super(VersionId.get(HistoryConstSocial2014.VERSION_CODE));
  }
