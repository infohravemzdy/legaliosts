...
import { HistoryConstSocial2017 } from './HistoryConstSocial2017';
import bigDecimal = require('js-big-decimal');

export class ProviderSocial2017 extends ProviderBase implements IProviderSocial {
  constructor() {
    super(VersionId.get(HistoryConstSocial2017.VERSION_CODE));
  }
