...
export class PropsHealth2010 extends PropsHealthBase implements IPropsHealth {
  constructor(
    version: VersionId,
  ...
  public static empty(): IPropsHealth {
    return new PropsHealth2010(VersionId.new(), 0, 0, 0, 0, new bigDecimal(0), new bigDecimal(0), 0, 0);
  }
