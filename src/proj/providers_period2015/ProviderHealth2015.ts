...
import { HistoryConstHealth2015 } from './HistoryConstHealth2015';
import bigDecimal = require('js-big-decimal');

export class ProviderHealth2015 extends ProviderBase implements IProviderHealth {
  constructor() {
    super(VersionId.get(HistoryConstHealth2015.VERSION_CODE));
  }
