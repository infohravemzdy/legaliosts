...
import { HistoryConstTaxing2015 } from './HistoryConstTaxing2015';
import bigDecimal = require('js-big-decimal');

export class ProviderTaxing2015 extends ProviderBase implements IProviderTaxing {
  constructor() {
    super(VersionId.get(HistoryConstTaxing2015.VERSION_CODE));
  }
  ...
  FactorSolitary(period: IPeriod): bigDecimal {
    return HistoryConstTaxing2015.FACTOR_SOLITARY;
  }
  ...
  MarginIncomeOfSolitary(period: IPeriod): number {
    return HistoryConstTaxing2015.MARGIN_INCOME_OF_SOLITARY;
  }
