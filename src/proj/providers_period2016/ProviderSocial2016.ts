...
import { HistoryConstSocial2016 } from './HistoryConstSocial2016';
import bigDecimal = require('js-big-decimal');

export class ProviderSocial2016 extends ProviderBase implements IProviderSocial {
  constructor() {
    super(VersionId.get(HistoryConstSocial2016.VERSION_CODE));
  }
