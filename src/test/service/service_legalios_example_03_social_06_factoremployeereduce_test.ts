...
describe('Service Social For Year 2010-2022 FactorEmployeeReduce', () => {
  const scenarios = [
  ...
  logTestDecExamples('03_Social_06_FactorEmployeeReduce.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.FactorEmployeeReduce()).to.eql(tt.expected);
        });
      });
    });
  });
