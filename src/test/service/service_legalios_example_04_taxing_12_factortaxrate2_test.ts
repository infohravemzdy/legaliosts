...
describe('Service Taxing For Year 2010-2022 FactorTaxRate2', () => {
  const scenarios = [
    ...
    new TestDecScenario('2013', [
      ...
      new TestDecParams('2013-2', 2013, 2, 2013, 2, new bigDecimal(0.0)),
      new TestDecParams('2013-3', 2013, 3, 2013, 3, new bigDecimal(0.0)),
      new TestDecParams('2013-4', 2013, 4, 2013, 4, new bigDecimal(0.0)),
      new TestDecParams('2013-5', 2013, 5, 2013, 5, new bigDecimal(0.0)),
      new TestDecParams('2013-6', 2013, 6, 2013, 6, new bigDecimal(0.0)),
      new TestDecParams('2013-7', 2013, 7, 2013, 7, new bigDecimal(0.0)),
      new TestDecParams('2013-8', 2013, 8, 2013, 8, new bigDecimal(0.0)),
      new TestDecParams('2013-9', 2013, 9, 2013, 9, new bigDecimal(0.0)),
      new TestDecParams('2013-10', 2013, 10, 2013, 10, new bigDecimal(0.0)),
      new TestDecParams('2013-11', 2013, 11, 2013, 11, new bigDecimal(0.0)),
      new TestDecParams('2013-12', 2013, 12, 2013, 12, new bigDecimal(0.0)),
    ]),
    new TestDecScenario('2014', [
      new TestDecParams('2014-1', 2014, 1, 2014, 1, new bigDecimal(0.0)),
      new TestDecParams('2014-2', 2014, 2, 2014, 2, new bigDecimal(0.0)),
      new TestDecParams('2014-3', 2014, 3, 2014, 3, new bigDecimal(0.0)),
      new TestDecParams('2014-4', 2014, 4, 2014, 4, new bigDecimal(0.0)),
      new TestDecParams('2014-5', 2014, 5, 2014, 5, new bigDecimal(0.0)),
      new TestDecParams('2014-6', 2014, 6, 2014, 6, new bigDecimal(0.0)),
      new TestDecParams('2014-7', 2014, 7, 2014, 7, new bigDecimal(0.0)),
      new TestDecParams('2014-8', 2014, 8, 2014, 8, new bigDecimal(0.0)),
      new TestDecParams('2014-9', 2014, 9, 2014, 9, new bigDecimal(0.0)),
      new TestDecParams('2014-10', 2014, 10, 2014, 10, new bigDecimal(0.0)),
      new TestDecParams('2014-11', 2014, 11, 2014, 11, new bigDecimal(0.0)),
      new TestDecParams('2014-12', 2014, 12, 2014, 12, new bigDecimal(0.0)),
    ]),
    ...
    new TestDecScenario('2021', [
      new TestDecParams('2021-1', 2021, 1, 2021, 1, new bigDecimal(23.0)),
      new TestDecParams('2021-2', 2021, 2, 2021, 2, new bigDecimal(23.0)),
      new TestDecParams('2021-3', 2021, 3, 2021, 3, new bigDecimal(23.0)),
      new TestDecParams('2021-4', 2021, 4, 2021, 4, new bigDecimal(23.0)),
      new TestDecParams('2021-5', 2021, 5, 2021, 5, new bigDecimal(23.0)),
      new TestDecParams('2021-6', 2021, 6, 2021, 6, new bigDecimal(23.0)),
      new TestDecParams('2021-7', 2021, 7, 2021, 7, new bigDecimal(23.0)),
      new TestDecParams('2021-8', 2021, 8, 2021, 8, new bigDecimal(23.0)),
      new TestDecParams('2021-9', 2021, 9, 2021, 9, new bigDecimal(23.0)),
      new TestDecParams('2021-10', 2021, 10, 2021, 10, new bigDecimal(23.0)),
      new TestDecParams('2021-11', 2021, 11, 2021, 11, new bigDecimal(23.0)),
      new TestDecParams('2021-12', 2021, 12, 2021, 12, new bigDecimal(23.0)),
    ]),
    new TestDecScenario('2022', [
      new TestDecParams('2022-1', 2022, 1, 2022, 1, new bigDecimal(23.0)),
      new TestDecParams('2022-2', 2022, 2, 2022, 2, new bigDecimal(23.0)),
      new TestDecParams('2022-3', 2022, 3, 2022, 3, new bigDecimal(23.0)),
      new TestDecParams('2022-4', 2022, 4, 2022, 4, new bigDecimal(23.0)),
      new TestDecParams('2022-5', 2022, 5, 2022, 5, new bigDecimal(23.0)),
      new TestDecParams('2022-6', 2022, 6, 2022, 6, new bigDecimal(23.0)),
      new TestDecParams('2022-7', 2022, 7, 2022, 7, new bigDecimal(23.0)),
      new TestDecParams('2022-8', 2022, 8, 2022, 8, new bigDecimal(23.0)),
      new TestDecParams('2022-9', 2022, 9, 2022, 9, new bigDecimal(23.0)),
      new TestDecParams('2022-10', 2022, 10, 2022, 10, new bigDecimal(23.0)),
      new TestDecParams('2022-11', 2022, 11, 2022, 11, new bigDecimal(23.0)),
      new TestDecParams('2022-12', 2022, 12, 2022, 12, new bigDecimal(23.0)),
    ]),
  ];
  logTestDecExamples('04_Taxing_12_FactorTaxRate2.txt', scenarios);
