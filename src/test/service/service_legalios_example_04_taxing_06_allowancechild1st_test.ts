...
describe('Service Taxing For Year 2010-2022 AllowanceChild1st', () => {
  const scenarios = [
  ...
  logTestNumExamples('04_Taxing_06_AllowanceChild1st.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.AllowanceChild1st()).to.equal(tt.expected);
        });
      });
    });
  });
