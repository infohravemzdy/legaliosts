...
describe('Service Salary For Year 2010-2022 MinHourlyWage', () => {
  const scenarios = [
    ...
    new TestIntScenario('2022', [
      new TestIntParams('2022-1', 2022, 1, 2022, 1, 9050),
      new TestIntParams('2022-2', 2022, 2, 2022, 2, 9050),
      new TestIntParams('2022-3', 2022, 3, 2022, 3, 9050),
      new TestIntParams('2022-4', 2022, 4, 2022, 4, 9050),
      new TestIntParams('2022-5', 2022, 5, 2022, 5, 9050),
      new TestIntParams('2022-6', 2022, 6, 2022, 6, 9050),
      new TestIntParams('2022-7', 2022, 7, 2022, 7, 9050),
      new TestIntParams('2022-8', 2022, 8, 2022, 8, 9050),
      new TestIntParams('2022-9', 2022, 9, 2022, 9, 9050),
      new TestIntParams('2022-10', 2022, 10, 2022, 10, 9050),
      new TestIntParams('2022-11', 2022, 11, 2022, 11, 9050),
      new TestIntParams('2022-12', 2022, 12, 2022, 12, 9050),
    ]),
  ];
  logTestNumExamples('02_Salary_04_MinHourlyWage.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.MinHourlyWage()).to.equal(tt.expected);
        });
      });
    });
  });
