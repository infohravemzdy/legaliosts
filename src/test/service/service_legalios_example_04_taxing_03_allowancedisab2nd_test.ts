...
describe('Service Taxing For Year 2011-2022 AllowanceDisab2nd', () => {
  const scenarios = [
  ...
  logTestNumExamples('04_Taxing_03_AllowanceDisab2nd.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.AllowanceDisab2nd()).to.equal(tt.expected);
        });
      });
    });
  });
