...
describe('Service Social For Year 2010-2022 FactorEmployerHigher', () => {
  const scenarios = [
    ...
    new TestDecScenario('2011', [
      new TestDecParams('2011-1', 2011, 1, 2011, 1, new bigDecimal(26.0)),
      new TestDecParams('2011-2', 2011, 2, 2011, 2, new bigDecimal(26.0)),
      new TestDecParams('2011-3', 2011, 3, 2011, 3, new bigDecimal(26.0)),
      new TestDecParams('2011-4', 2011, 4, 2011, 4, new bigDecimal(26.0)),
      new TestDecParams('2011-5', 2011, 5, 2011, 5, new bigDecimal(26.0)),
      new TestDecParams('2011-6', 2011, 6, 2011, 6, new bigDecimal(26.0)),
      new TestDecParams('2011-7', 2011, 7, 2011, 7, new bigDecimal(26.0)),
      new TestDecParams('2011-8', 2011, 8, 2011, 8, new bigDecimal(26.0)),
      new TestDecParams('2011-9', 2011, 9, 2011, 9, new bigDecimal(26.0)),
      new TestDecParams('2011-10', 2011, 10, 2011, 10, new bigDecimal(26.0)),
      new TestDecParams('2011-11', 2011, 11, 2011, 11, new bigDecimal(26.0)),
      new TestDecParams('2011-12', 2011, 12, 2011, 12, new bigDecimal(26.0)),
    ]),
    new TestDecScenario('2012', [
      new TestDecParams('2012-1', 2012, 1, 2012, 1, new bigDecimal(26.0)),
      new TestDecParams('2012-2', 2012, 2, 2012, 2, new bigDecimal(26.0)),
      new TestDecParams('2012-3', 2012, 3, 2012, 3, new bigDecimal(26.0)),
      new TestDecParams('2012-4', 2012, 4, 2012, 4, new bigDecimal(26.0)),
      new TestDecParams('2012-5', 2012, 5, 2012, 5, new bigDecimal(26.0)),
      new TestDecParams('2012-6', 2012, 6, 2012, 6, new bigDecimal(26.0)),
      new TestDecParams('2012-7', 2012, 7, 2012, 7, new bigDecimal(26.0)),
      new TestDecParams('2012-8', 2012, 8, 2012, 8, new bigDecimal(26.0)),
      new TestDecParams('2012-9', 2012, 9, 2012, 9, new bigDecimal(26.0)),
      new TestDecParams('2012-10', 2012, 10, 2012, 10, new bigDecimal(26.0)),
      new TestDecParams('2012-11', 2012, 11, 2012, 11, new bigDecimal(26.0)),
      new TestDecParams('2012-12', 2012, 12, 2012, 12, new bigDecimal(26.0)),
    ]),
    new TestDecScenario('2013', [
      new TestDecParams('2013-1', 2013, 1, 2013, 1, new bigDecimal(26.0)),
      new TestDecParams('2013-2', 2013, 2, 2013, 2, new bigDecimal(26.0)),
      new TestDecParams('2013-3', 2013, 3, 2013, 3, new bigDecimal(26.0)),
      new TestDecParams('2013-4', 2013, 4, 2013, 4, new bigDecimal(26.0)),
      new TestDecParams('2013-5', 2013, 5, 2013, 5, new bigDecimal(26.0)),
      new TestDecParams('2013-6', 2013, 6, 2013, 6, new bigDecimal(26.0)),
      new TestDecParams('2013-7', 2013, 7, 2013, 7, new bigDecimal(26.0)),
      new TestDecParams('2013-8', 2013, 8, 2013, 8, new bigDecimal(26.0)),
      new TestDecParams('2013-9', 2013, 9, 2013, 9, new bigDecimal(26.0)),
      new TestDecParams('2013-10', 2013, 10, 2013, 10, new bigDecimal(26.0)),
      new TestDecParams('2013-11', 2013, 11, 2013, 11, new bigDecimal(26.0)),
      new TestDecParams('2013-12', 2013, 12, 2013, 12, new bigDecimal(26.0)),
    ]),
    new TestDecScenario('2014', [
      new TestDecParams('2014-1', 2014, 1, 2014, 1, new bigDecimal(26.0)),
      new TestDecParams('2014-2', 2014, 2, 2014, 2, new bigDecimal(26.0)),
      new TestDecParams('2014-3', 2014, 3, 2014, 3, new bigDecimal(26.0)),
      new TestDecParams('2014-4', 2014, 4, 2014, 4, new bigDecimal(26.0)),
      new TestDecParams('2014-5', 2014, 5, 2014, 5, new bigDecimal(26.0)),
      new TestDecParams('2014-6', 2014, 6, 2014, 6, new bigDecimal(26.0)),
      new TestDecParams('2014-7', 2014, 7, 2014, 7, new bigDecimal(26.0)),
      new TestDecParams('2014-8', 2014, 8, 2014, 8, new bigDecimal(26.0)),
      new TestDecParams('2014-9', 2014, 9, 2014, 9, new bigDecimal(26.0)),
      new TestDecParams('2014-10', 2014, 10, 2014, 10, new bigDecimal(26.0)),
      new TestDecParams('2014-11', 2014, 11, 2014, 11, new bigDecimal(26.0)),
      new TestDecParams('2014-12', 2014, 12, 2014, 12, new bigDecimal(26.0)),
    ]),
    new TestDecScenario('2015', [
      new TestDecParams('2015-1', 2015, 1, 2015, 1, new bigDecimal(0.0)),
      new TestDecParams('2015-2', 2015, 2, 2015, 2, new bigDecimal(0.0)),
      new TestDecParams('2015-3', 2015, 3, 2015, 3, new bigDecimal(0.0)),
      new TestDecParams('2015-4', 2015, 4, 2015, 4, new bigDecimal(0.0)),
      new TestDecParams('2015-5', 2015, 5, 2015, 5, new bigDecimal(0.0)),
      new TestDecParams('2015-6', 2015, 6, 2015, 6, new bigDecimal(0.0)),
      new TestDecParams('2015-7', 2015, 7, 2015, 7, new bigDecimal(0.0)),
      new TestDecParams('2015-8', 2015, 8, 2015, 8, new bigDecimal(0.0)),
      new TestDecParams('2015-9', 2015, 9, 2015, 9, new bigDecimal(0.0)),
      new TestDecParams('2015-10', 2015, 10, 2015, 10, new bigDecimal(0.0)),
      new TestDecParams('2015-11', 2015, 11, 2015, 11, new bigDecimal(0.0)),
      new TestDecParams('2015-12', 2015, 12, 2015, 12, new bigDecimal(0.0)),
    ]),
  ...
  logTestDecExamples('03_Social_03_FactorEmployerHigher.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.FactorEmployerHigher()).to.eql(tt.expected);
        });
      });
    });
  });
