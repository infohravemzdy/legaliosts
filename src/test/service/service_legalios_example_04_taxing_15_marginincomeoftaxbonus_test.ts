...
describe('Service Taxing For Year 2010-2022 MarginIncomeOfTaxBonus', () => {
  const scenarios = [
    ...
    new TestIntScenario('2022', [
      new TestIntParams('2022-1', 2022, 1, 2022, 1, 7600),
      new TestIntParams('2022-2', 2022, 2, 2022, 2, 7600),
      new TestIntParams('2022-3', 2022, 3, 2022, 3, 7600),
      new TestIntParams('2022-4', 2022, 4, 2022, 4, 7600),
      new TestIntParams('2022-5', 2022, 5, 2022, 5, 7600),
      new TestIntParams('2022-6', 2022, 6, 2022, 6, 7600),
      new TestIntParams('2022-7', 2022, 7, 2022, 7, 7600),
      new TestIntParams('2022-8', 2022, 8, 2022, 8, 7600),
      new TestIntParams('2022-9', 2022, 9, 2022, 9, 7600),
      new TestIntParams('2022-10', 2022, 10, 2022, 10, 7600),
      new TestIntParams('2022-11', 2022, 11, 2022, 11, 7600),
      new TestIntParams('2022-12', 2022, 12, 2022, 12, 7600),
    ]),
  ];
  logTestNumExamples('04_Taxing_15_MarginIncomeOfTaxBonus.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.MarginIncomeOfTaxBonus()).to.equal(tt.expected);
        });
      });
    });
  });
