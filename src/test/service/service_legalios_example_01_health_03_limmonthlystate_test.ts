...
describe('Service Health For Year 2010-2022 LimMonthlyState', () => {
  const scenarios = [
  ...
  logTestNumExamples('01_Health_03_LimMonthlyState.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.LimMonthlyState()).to.equal(tt.expected);
        });
      });
    });
  });
