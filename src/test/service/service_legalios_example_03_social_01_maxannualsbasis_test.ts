...
describe('Service Social For Year 2011-2022 MaxAnnualsBasis', () => {
  const scenarios = [
    ...
    new TestIntScenario('2022', [
      new TestIntParams('2022-1', 2022, 1, 2022, 1, 1701168),
      new TestIntParams('2022-2', 2022, 2, 2022, 2, 1701168),
      new TestIntParams('2022-3', 2022, 3, 2022, 3, 1701168),
      new TestIntParams('2022-4', 2022, 4, 2022, 4, 1701168),
      new TestIntParams('2022-5', 2022, 5, 2022, 5, 1701168),
      new TestIntParams('2022-6', 2022, 6, 2022, 6, 1701168),
      new TestIntParams('2022-7', 2022, 7, 2022, 7, 1701168),
      new TestIntParams('2022-8', 2022, 8, 2022, 8, 1701168),
      new TestIntParams('2022-9', 2022, 9, 2022, 9, 1701168),
      new TestIntParams('2022-10', 2022, 10, 2022, 10, 1701168),
      new TestIntParams('2022-11', 2022, 11, 2022, 11, 1701168),
      new TestIntParams('2022-12', 2022, 12, 2022, 12, 1701168),
    ]),
  ];
  logTestNumExamples('03_Social_01_MaxAnnualsBasis.txt', scenarios);
    ...
    describe(`year ${tx.title}`, () => {
      tx.tests.forEach((tt) => {
        ...
        it(`GetProps should return value = ${tt.expected}`, () => {
          expect(props.MaxAnnualsBasis()).to.equal(tt.expected);
        });
      });
    });
  });
